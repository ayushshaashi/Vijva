...
exports.createUser = async (req, res) => {
    ...
    res.json({success: true, user: {name: newUser.name, email: newUser.email, id: newUser.id, verified: newUser.verified}});
};
...
exports.createUser = async (req, res) => {
    const { name, email, password, phone, address, emergencyContacts } = req.body;
    const user = await User.findOne({ email });
    if (user) return sendError(res, 'This email is already registered!');
